      ...
      {tab==="companies"&&selCo&&(function(){
        ...
        return(<div>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:14,flexWrap:"wrap"}}>
            ...
            {mosStyle&&<span style={{fontSize:12,padding:"2px 10px",borderRadius:99,background:mosStyle.bg,color:mosStyle.color,fontWeight:600}}>MOS: {fmtMOS(mos)}</span>} {(selCo.tickers||[]).filter(function(t){return t.price;}).map(function(t){return <span key={t.ticker} style={{fontSize:12,padding:"2px 10px",borderRadius:99,background:T.bgSec,border:"1px solid "+T.border,color:T.text}}>{t.ticker}: {t.currency||""} {fmtPrice(t.price)}</span>;})}
          </div>
          {/* Tabs */}
