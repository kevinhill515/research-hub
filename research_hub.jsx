...
const SUPA_URL="https://vesnqbxswmggdfevqokt.supabase.co"; async function supaGet(table,key,val){var r=await fetch(SUPA_URL+"/rest/v1/"+table+"?select=data&"+key+"=eq."+val,{headers:{"apikey":"sb_publishable_7kqbGZlL_im9kIpgFXLA-A_9CdqsyiT","Authorization":"Bearer sb_publishable_7kqbGZlL_im9kIpgFXLA-A_9CdqsyiT","Accept":"application/vnd.pgrst.object+json"}});if(!r.ok)return null;try{return await r.json();}catch(e){return null;}} async function supaUpsert(table,obj){return fetch(SUPA_URL+"/rest/v1/"+table,{method:"POST",headers:{"apikey":"sb_publishable_7kqbGZlL_im9kIpgFXLA-A_9CdqsyiT","Authorization":"Bearer sb_publishable_7kqbGZlL_im9kIpgFXLA-A_9CdqsyiT","Content-Type":"application/json","Prefer":"resolution=merge-duplicates"},body:JSON.stringify(obj)});}    from:function(table){     var base=SUPA_URL+"/rest/v1/"+table;     var headers={"Content-Type":"application/json","apikey":SUPA_KEY,"Authorization":"Bearer "+SUPA_KEY};     return{       select:function(col){return{eq:function(k,v){return{single:function(){return fetch(base+"?select="+col+"&"+k+"=eq."+v,{headers:Object.assign({},headers,{"Accept":"application/vnd.pgrst.object+json"})}).then(function(r){return r.ok?r.json().then(function(d){return{data:d};}).catch(function(){return{data:null};}):Promise.resolve({data:null});});}}};};},       upsert:function(obj){return fetch(base,{method:"POST",headers:Object.assign({},headers,{"Prefer":"resolution=merge-duplicates"}),body:JSON.stringify(obj)}).then(function(){return{data:null};}).catch(function(){return{data:null};});}     };   } };
