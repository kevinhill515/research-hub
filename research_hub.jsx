...
export default function App(){
  ...
  const [quickUploadCo,setQuickUploadCo]=useState(null); const [calImportText,setCalImportText]=useState(""); function applyCalImport(){if(!calImportText||!calImportText.trim())return;var lines=calImportText.trim().replace(/
/g,"").split("
