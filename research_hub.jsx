...
const ACTIONS=["Increase TP","No Action","Decrease TP"];
...
export default function App(){
  ...
  return(
    <div style={{padding:"1rem",boxSizing:"border-box",fontFamily:"system-ui,sans-serif",fontSize:14,color:T.text,background:T.bg,minHeight:"100vh"}}>
