...
const AVG_WPM=200;
const ALL_COLS=["Tier(s)","Name","Ticker","Country","Sector","Portfolio","Action","Notes","Reviewed","Updated","Status","MOS","Del"];
const COMPACT_COLS=new Set(["Tier(s)","Name","Ticker","Status","Reviewed","MOS","Del"]);
