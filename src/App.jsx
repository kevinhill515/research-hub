    ...
    <div className={"min-h-screen p-4 font-[system-ui,sans-serif] text-sm text-gray-900 dark:text-slate-100 bg-white dark:bg-slate-950 " + (dark ? "dark" : "")}>
      ...
      {showSettings&&(<div className="fixed inset-0 bg-black/40 z-[1000] flex items-center justify-center" onClick={function(){setShowSettings(false);}}>
        <div onClick={function(e){e.stopPropagation();}} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-6 py-5 w-[460px] max-w-[92vw] shadow-2xl">
          <div className="text-[15px] font-semibold text-gray-900 dark:text-slate-100 mb-1">Settings</div>
          <div className="text-xs text-gray-500 dark:text-slate-400 mb-4">Per-browser. Nothing here is shared with teammates.</div>
          <div className="mb-3">
