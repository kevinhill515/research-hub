...
export function tierPillStyle(t){if(!t)return{bg:"#334155",color:"#fff"};if(t.indexOf("FOC")===0)return{bg:"#1a3a6b",color:"#fff"};if(t.indexOf("INGL")===0)return{bg:"#b45309",color:"#fff"};if(t==="IN1"||t==="IN2")return{bg:"#0f766e",color:"#fff"};if(t.indexOf("US")===0)return{bg:"#1a3a6b",color:"#fff"};if(t.indexOf("EM")===0)return{bg:"#92400e",color:"#fff"};if(t.indexOf("SC")===0)return{bg:"#5b21b6",color:"#fff"};if(t.indexOf("F ")===0||t.indexOf("W ")===0)return{bg:"#9d174d",color:"#fff"};if(t==="Hit TP")return{bg:"#64748b",color:"#fff"};if(t==="Gave Up")return{bg:"#94a3b8",color:"#fff"};return{bg:"#334155",color:"#fff"};}
export function tierBg(t){var tiers=getTiers(t),first=tiers[0]||"";if(!first)return"#ffffff";if(first.indexOf("FOC")===0)return"#e8f0f8";if(first.indexOf("INGL")===0)return"#fde8d8";if(first==="IN1"||first==="IN2")return"#d1faf4";if(first.indexOf("US")===0)return"#e8f5ee";if(first.indexOf("EM")===0)return"#fef6e4";if(first.indexOf("SC")===0)return"#f0ecfb";if(first.indexOf("F ")===0||first.indexOf("W ")===0)return"#fceef4";if(first==="Hit TP")return"#f1f5f9";if(first==="Gave Up")return"#f8fafc";return"#ffffff";}
