...
export function reviewedColor(dateStr,T){var d=daysSince(dateStr);if(d===Infinity)return T.textDanger;if(d>90)return"#dc2626";if(d>60)return"#d97706";if(d>30)return"#ca8a04";return T.textSuccess;}
