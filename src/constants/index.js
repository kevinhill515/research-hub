export const PORTFOLIOS=["GL","FGL","IV","FIV","EM","SC"];
export const TIER_ORDER=["MC1","MC2","MC3","MC4","MC5","INTL","US1","US2","EM1","EM2","EM3","EM4","SC1","SC2","SC3","SC4","SC5","F MC","W MC","F SC","W SC","Hit TP","Gave Up"];
...
export const ALL_CURRENCIES=["USD","EUR","GBP","JPY","CHF","SEK","NOK","DKK","CAD","AUD","TWD","CNY","SGD","INR","BRL","MXN","CLP","ZAR","IDR","KRW","HUF","ILS","EGP","JOD","RUB"];
export const MONTHS=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];
export const CO_SORTS=["Tier","Last Reviewed","Sector","Country","Name","MOS"];
...
export const PRESET_TAGS=["Company Template","Macro","FIV","IV","FGL","GL","EM","SC"];
...
export const ALL_COLS=["Tier(s)","Name","Ticker","Country","Sector","Portfolio","Action","Notes","Reviewed","Updated","Status","Flag","Del"];
export const COMPACT_COLS=new Set(["Tier(s)","Name","Ticker","Status","Reviewed","Flag","Del"]);
