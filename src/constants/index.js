...
export const ALL_COLS=["Tier(s)","Name","5D%","MOS","Country","Sector","Portfolio","Action","Notes","Reviewed","Updated","Status","Flag","Del"];
export const COMPACT_COLS=new Set(["Tier(s)","Name","5D%","MOS","Status","Reviewed","Flag","Del"]);
