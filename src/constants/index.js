...
export const ALL_COLS=["Tier(s)","Name","5D%","Country","Sector","Portfolio","Action","Notes","Reviewed","Updated","Status","Flag","Del"];
export const COMPACT_COLS=new Set(["Tier(s)","Name","5D%","Status","Reviewed","Flag","Del"]);
