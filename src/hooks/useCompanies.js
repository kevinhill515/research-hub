...
export function useCompanies(){
  ...
  function exportCSV(){
    var rows=[["Name","Ticker","Tier","Status","Country","Sector","Portfolio","Port?","Action","Notes","Last Reviewed","Price"]];
    displayedCos.forEach(function(c){var v=c.valuation||{};rows.push([c.name,c.ticker||"",getTiers(c.tier).join(", "),c.status||"",c.country||"",c.sector||"",(c.portfolios||[]).join(", "),c.portNote||"",c.action||"",c.takeaway||"",c.lastReviewed||"",v.price||""]);});
