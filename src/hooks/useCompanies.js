...
export function useCompanies(){
  ...
  function handleSortClick(colSort){     if(coSort===colSort){setCoSortDir(function(d){return d==="asc"?"desc":"asc";});}     else{setCoSort(colSort);setCoSortDir(colSort==="Last Reviewed"?"desc":"asc");}   }
